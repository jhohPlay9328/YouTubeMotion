...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final GestureLibraryAccessors laccForGestureLibraryAccessors = new GestureLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>gesture</b>
     */
    public GestureLibraryAccessors getGesture() {
        return laccForGestureLibraryAccessors;
    }
    ...
    public static class AndroidxMedia3LibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>media3DatasourceRtmp</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidxMedia3DatasourceLibraryAccessors extends SubDependencyFactory {

        public AndroidxMedia3DatasourceLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>rtmp</b> with <b>androidx.media3:media3-datasource-rtmp</b> coordinates and
         * with version reference <b>media3DatasourceRtmp</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class GestureLibraryAccessors extends SubDependencyFactory {

        public GestureLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>views</b> with <b>com.alexvasilkov:gesture-views</b> coordinates and
         * with version reference <b>gestureViews</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getViews() {
            return create("gesture.views");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>databindingCommon</b> with value <b>8.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>gestureViews</b> with value <b>2.8.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGestureViews() { return getVersion("gestureViews"); }
        ...
        /**
         * Version alias <b>kapt</b> with value <b>1.9.23</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>media3DatasourceRtmp</b> with value <b>1.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMedia3DatasourceRtmp() { return getVersion("media3DatasourceRtmp"); }
